...
function Html2ReactParser(options) {
  function parseHtmlToTree(html) {
    var handler = new htmlParser.DomHandler(undefined, {
  ...
  function parseWithInstructions(html, isValidNode, processingInstructions) {
    ...
    return mapParsedTree(domTree, isValidNode, processingInstructions);
  }
  
  function mapParsedTree(domTree, isValidNode, processingInstructions) {
